# begin
@log.trace("Started executing 'zendesk:list_users.rb' flintbit...")
begin
    ...
    @action = 'list-users' # Contains the name of the operation: list-users
...
@log.trace("Finished executing 'zendesk:list_users.rb' flintbit...")
# end
