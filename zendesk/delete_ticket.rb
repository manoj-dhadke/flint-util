# begin
@log.trace("Started executing 'zendesk:show_ticket.rb' flintbit...")
begin
    ...
    @action = 'delete-ticket' # Contains the name of the operation: list-tickets
    @id = @input.get('ticket-id') #Provide Ticket Id to delete ticket
 ...
 if @request_timeout.nil? || @request_timeout.is_a?(String)
    ...
    if response_exitcode == 0
        ...
        @output.set('exit-code', response_exitcode).set('error', response_message)
    end
rescue Exception => e
    @log.error(e.message)
    @output.set('exit-code', -1).set('message', e.message)
end
@log.trace("Finished executing 'zendesk:show_ticket.rb' flintbit...")
# end
