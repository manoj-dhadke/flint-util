# begin
@log.trace("Started executing 'zendesk:add_comment.rb' flintbit...")
begin
    ...
    @action = 'add-comment' # Contains the name of the operation: add-comment
    ...
    if  @input.get('comment').nil? ||  @input.get('comment').empty?
     raise 'Please provide comment to add'
    end
