...
# begin
@log.trace("Started executing 'zendesk:list_problems.rb' flintbit...")
begin
    ...
    @action = 'list-incidents' # Contains the name of the operation: list-incidents
    @ticket_id = @input.get('ticket-id')
    @request_timeout = @input.get('timeout')

    if @connector_name.nil? || @connector_name.empty?
     raise 'Please provide "Zendesk connector name (connector_name)" '
    end
    if @incident_id.nil? || @incident_id.empty?
     raise 'Please provide "incident-id" '
    end
...
@log.trace("Finished executing 'zendesk:list_problems.rb' flintbit...")
# end
