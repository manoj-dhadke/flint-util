...
# begin
@log.trace("Started executing 'zendesk:create_custom_field_by_json.rb' flintbit...")
begin
...
@log.trace("Finished executing 'zendesk:create_custom_field_by_json.rb' flintbit...")
# end
