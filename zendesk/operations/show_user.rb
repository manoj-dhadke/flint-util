...
begin
    ...
    @action = 'show-user' # Contains the name of the operation: show-user
    @user_id = @input.get('user-id') #Provide Ticket Id to view its details
    ...
    @log.info("Flintbit input parameters are, connector name :: #{@connector_name} |action :: #{@action}  | user-id :: #{@user_id}")
