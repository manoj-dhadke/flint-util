...
# begin
@log.trace("Started executing 'zendesk:list_recent_tickets.rb' flintbit...")
begin
    ...
    @action = 'list-recent-tickets' # Contains the name of the operation: list-recent-tickets
...
@log.trace("Finished executing 'zendesk:list_recent_tickets.rb' flintbit...")
# end
