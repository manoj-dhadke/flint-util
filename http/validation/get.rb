...
# begin
@log.trace("Started executing 'flint-util:http:validation:get.rb' flintbit...")
begin
    ...
    request_method = 'get' if request_method.nil? || request_method.empty?
    request_url = 'http://httpbin.org/get' if request_url.nil? || request_url.empty?
...
@log.trace("Finished execution 'flint-util:http:validation:get.rb' flintbit...")
# end
