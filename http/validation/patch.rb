...
# begin
@log.trace("Started executing 'flint-util:http:validation:patch.rb' flintbit...")
begin
    ...
    @request_method = 'patch' if @request_method.nil? || @request_method.empty?
...
@log.trace("Finished execution 'flint-util:http:validation:patch.rb' flintbit...")
# end
