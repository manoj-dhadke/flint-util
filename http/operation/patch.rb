...
# begin
@log.trace("Started executing 'flint-util:http:operation:patch.rb' flintbit...")
begin
    # Flintbit Input Parameters
    # mandatory
    @connector_name = @input.get('connector_name') # Name of the HTTP Connector
    @request_method = 'patch'       # HTTP Request Method
...
@log.trace("Finished execution 'flint-util:http:operation:patch.rb' flintbit...")
# end
