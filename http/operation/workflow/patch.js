 ...
 * Summary: PATCH method of HTTP
 * Description: To PATCH data from a URL using HTTP Connector
 */

//Starting execution of flintbit
log.trace("Started executing 'flint-util:http:operation:workflow:patch.js'");
...
if(response_exitcode==0){
    ...
    log.trace("Finished executing 'flint-util:http:operation:workflow:patch.js' successfully")
}
