...
@log.trace("Started execution of 'flint-util:jira:operation:assign_issue.rb' flntbit..")
begin
    # Getting input parameters
    @connector_name = @input.get('connector_name')
    @issue_id = @input.get('issue-id')       # Id of issue in Jira
    @username = @input.get('username')       # Username of user
...
@log.trace("Finished execution of 'flint-util:jira:operation:assign_issue.rb' flntbit..")
