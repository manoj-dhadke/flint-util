...
@log.trace("Started execution of 'flint-util:jira:operation:get_comment.rb' flntbit..")
begin
    # Getting input parameters
    @connector_name = @input.get('connector_name')
    @issue_id = @input.get('issue-id')       # Id of issue in Jira
    @comment_id = @input.get('comment-id')   # Id of comment on issue
    @action = 'update-comment'               # Action of jira connector
...
@log.trace("Finished execution of 'flint-util:jira:operation:get_comment.rb' flntbit..")
