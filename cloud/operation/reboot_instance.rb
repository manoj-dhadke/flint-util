#begin
@log.trace("Started executing 'flint-util:jcloud:operation:reboot_instance.rb' flintbit...")
...
@log.trace("Finished executing 'flint-util:jcloud:operation:reboot_instance.rb' flintbit...")
#end
