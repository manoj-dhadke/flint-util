...
# begin
@log.trace("Started executing 'flint-util:cloud:operation:create_instance.rb' flintbit...")
begin
    # Flintbit Input Parameters
    # Mandatory
    @connector_name = @input.get('connector_name') # Name of the Cloud Connector
    @action = @input.get('action')                 # Action
    @locationId = @input.get('location-id')
    @imageId = @input.get('image-id')
    @hardwareId = @input.get('hardware-id')
    # optional
    ...
    result = response.get('create-instance') # Response body
