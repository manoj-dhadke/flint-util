#begin
@log.trace("Started executing 'flint-util:jcloud:operation:start_instance.rb' flintbit...")
...
if response.exitcode == 0
	...
	@log.error("Failure in executing cloud Connector where, exitcode :: #{response_exitcode} | 
		                                               message ::  #{response_message}")
