...
work_description_ack = "Flint has recieved ticket with Ticket Id " + ": " + ticket_id + " " + "Flint is trying to resolve it. Flint job-id : " + " " + flint_job_id
...
if (exitcode == 0) {
 ...
 if (exitcode_response == 0) {
  body = "AD account password for logon name" + " " + loginname + " " + " reset successfully. The new password of the AD account is:" + " " + password
