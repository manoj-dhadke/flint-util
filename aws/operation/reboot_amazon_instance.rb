#begin
@log.trace("Started executing 'reboot_amazon_instance' flintbit...")
...
if response_exitcode == 0
  ...
  @log.info("Amazon EC2 rebooted instances :: #{instance_id.to_s}")
	...
	@log.trace("Finished executing 'reboot_amazon_instance' flintbit with success...")
else
	@log.error("Failure in executing Amazon EC2 Connector where, exitcode :: #{response_exitcode} |
																															 message ::  #{response_message}")
  @output.set("error",response_message)
  @log.trace("Finished executing 'reboot_amazon_instance' flintbit with error...")
end
#end
