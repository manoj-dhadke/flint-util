#begin
@log.trace("Started executing 'flint-util:aws:operation:create_tags.rb' flintbit...")
begin
...
if response_exitcode == 0
  ...
  @log.trace("Finished executing 'flint-util:aws:operation:create_tags.rb' flintbit")
#end
