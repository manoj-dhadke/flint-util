log.trace("Started executing 'flint:util:bmc_ars:delete_entry.groovy' flintbit...")
try{
    ...
    if (connector_name == null || connector_name ==""){
        throw new Exception( 'Please provide "BMC ARS connector name (connector_name)" to delete entry')
    }

    if (servername == null || servername ==""){
        throw new Exception( 'Please provide "BMC ARS Server Name Name (servername)" to delete entry')
    }
    if (username == null || username ==""){
        throw new Exception( 'Please provide "BMC ARS Username (username)" to delete entry')
    }
    if (password == null || password ==""){
        throw new Exception( 'Please provide "BMC ARS Password Name (password)" to delete entry')
    }

    if (port == null || port ==""){
        throw new Exception( 'Please provide "BMC ARS Port (port)" to delete entry')
    }

    if (form_name == null || form_name ==""){
        throw new Exception( 'Please provide "BMC ARS Form Name (form_name)" to delete entry')
    }

    if (entries == null || entries ==""){
        throw new Exception( 'Please provide "BMC ARS Enteries (entries)" to delete entry')
    }
...
log.trace("Finished executing 'flint:util:bmc_ars:delete_entry.groovy' flintbit...")
