...
# begin
@log.trace("Started executing 'flint-util:winrm:kerbros:ipconfig.rb' flintbit...")
begin
...
@log.trace("Finished execution of 'flint-util:winrm:kerbros:ipconfig.rb' flintbit...")
# end
