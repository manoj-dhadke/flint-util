...
# begin
@log.trace("Started executing 'flint-util:winrm:kerbros:execute_command.rb' flintbit...")
begin
...
@log.trace("Finished execution of 'flint-util:winrm:kerbros:execute_command.rb' flintbit...")
# end
