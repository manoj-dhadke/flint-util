...
# begin
@log.trace("Started executing 'flint-util:winrm:kerbros:pwd.rb' flintbit...")
begin
      hostname = @input.get('hostname')
      protocol = @input.get('protocol')
      krb5_realm = @input.get('kerb5_realm')
      bit_response = @call.bit('flint-util:winrm:connect:kerbros_connect.rb').set('command', 'echo %cd%').set('hostname', hostname)
...
@log.trace("Finished execution of 'flint-util:winrm:kerbros:pwd.rb' flintbit...")
# end
