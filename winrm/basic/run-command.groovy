 ...
 */
log.trace("Started executing 'flint-util:winrm:basic:run-command.groovy' flintbit...")
try{
    ...
    if (response_exitcode == 0){
        ...
        output.set('exit-code', 0).set('message', 'success').setraw("output",result.toString())                                                         
    }else{
...
log.trace("Finished executing 'flint-util:winrm:basic:run-command.groovy' flintbit...")
//end
