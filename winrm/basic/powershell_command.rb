# begin
@log.trace("Started executing 'flint-util:winrm:basic:powershell_command.rb' flintbit...")
begin
    ...
    bit_response = @call.bit('flint-util:winrm:connect:basic_auth_connect.rb').set('command', @command).set('hostname', hostname)
...
@log.trace("Finished execution of 'flint-util:winrm:basic:powershell_command.rb' flintbit...")
# end
