...
begin
              ...
              @action = 'add-resolution'                      # Add-resolution be executed
              @requestid = @input.get('requestid')            # Request-id of request
              @resolutiontext = @input.get('resolutiontext')  # Add Resolution for problem
              ...
              if response_exitcode == 0
                  ...
                  @log.trace("Finished executing 'manageengine' flintbit with success...")
              else
