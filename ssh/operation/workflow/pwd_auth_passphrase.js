...
log.trace("Started executing 'flint-util:ssh:operation:workflow:pwd_auth_passphrase.js'");
...
if(response_exitcode==0){                       //Successfull execution
    ...
    log.trace("finished executing 'flint-util:ssh:operation:workflow:pwd_auth_passphrase.js' successfully")
}
else{
    log.error("Failure in execution, message:"+response_message+" | exitcode:"+response_exitcode);
    output.set("error",response_message).set("exit-code",-1);
    log.trace("finished executing 'flint-util:ssh:operation:workflow:pwd_auth_passphrase.js' with errors")
}
