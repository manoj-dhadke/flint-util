...
command = input.get("command");                     //Command to be executed on target
...
if(connector_name!=null || connector_name!=""){
    ...
    log.error("Connector name not given");          //Connector mandatory
}
...
if(target!=null || target!=""){
    ...
    log.error("target not given");                  //Target mandatory
}
...
if(username!=null || username!=""){
    ...
    log.error("Username name not given");           //Username mandatory
}
...
if(type!=null || type!=""){
    ...
    log.error("Type of shell not given");             //Type mandatory
}
...
else{                                               //Not manadtory authentiation type
