...
@log.trace("Started execution 'activedirectory:create_user_account.rb' flintbit...") # execution Started
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "active-directory connector name (connector_name)" to create user account'
    end
...
@log.trace("Finished execution 'activedirectory:create_user_account.rb' flintbit...") # Execution Finished
