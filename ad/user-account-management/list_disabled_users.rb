...
@log.trace("Started execution 'ad:list_disabled__users.rb' flintbit...") # execution Started
begin
    ...
    connector_call = @call.connector(@connector_name)
                    .set('action',"list-disabled-user")
                    .set('distinguished-names', @dn)

    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "active-directory connector name (connector_name)" to list disabled users'
    end

    if @dn.nil? || @dn.empty?
        raise 'Please provide "user distinguished name (distinguished-names)" to list disabled users'
    end
...
@log.trace("Finished execution 'ldap:list_disabled__users.rb' flintbit...") # Execution Finished
