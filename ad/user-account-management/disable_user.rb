@log.trace("Started execution 'activedirectory:disable_user.rb' flintbit...") # execution Started
begin
  ...
  if @connector_name.nil? || @connector_name.empty?
      raise 'Please provide "active-directory connector name (connector_name)" to disable user account'
  end
...
@log.trace("Finished execution 'activedirectory:disable_user.rb' flintbit...") # Execution Finished
