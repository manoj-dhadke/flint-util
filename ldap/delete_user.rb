@log.trace("Started execution 'ldap:delete_user.rb' flintbit...") # execution Started
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "ldap connector name (connector_name)" to  delete user account'
    end
...
@log.trace("Finished execution 'ldap:delete_user.rb' flintbit...") # Execution Finished
