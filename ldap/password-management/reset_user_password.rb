...
@log.trace("Started execution 'ldap:reset_user_password.rb' flintbit...") # execution Started
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "ldap connector name (connector_name)" to reset user account password'
    end
...
@log.trace("Finished execution 'ldap:reset_user_password.rb' flintbit...") # Execution Finished
