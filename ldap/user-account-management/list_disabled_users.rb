...
@log.trace("Started execution 'ldap:list_disabled__users.rb' flintbit...") # execution Started
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "ldap connector name (connector_name)" to list disabled users'
    end
