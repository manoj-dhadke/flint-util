...
@log.trace("Started execution 'ldap:enable_user.rb' flintbit...") # execution Started
begin
...
@log.trace("Finished execution 'ldap:enable_user.rb' flintbit...") # Execution Finished
