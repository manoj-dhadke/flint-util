@log.trace("Started execution 'ldap:details_user.rb' flintbit...") # execution Started
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "ldap connector name (connector_name)" to  fetch details of user'
    end
...
@log.trace("Finished execution 'ldap:details_user.rb' flintbit...") # Execution Finished
