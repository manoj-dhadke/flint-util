@log.trace("Started execution 'activedirectory:enable_user.rb' flintbit...") # execution Started
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "LDAP connector name (connector_name)" to enable user account'
    end

    if @dn.nil? || @dn.empty?
        raise 'Please provide "user distinguished name (distinguished-names)" to enable user account'
    end
...
@log.trace("Finished execution 'activedirectory:enable_user.rb' flintbit...") # Execution Finished
